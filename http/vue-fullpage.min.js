...
!function (e, t) {
	...
	return function (e) {
		...
		!function (r, i, l, a, s) {
			...
			function r(e) {
				...
				for (var t = 1, n = arguments.length; t < n; ++t) {
					var o = arguments[t];
					if (o)for (var i in o)o.hasOwnProperty(i) && ("[object Object]" !== Object.prototype.toString.call(o[i]) ? e[i] = o[i] : e[i] = r(e[i], o[i]))
				}
				return e
			}
			...
			function s(e, t) {
				var n;
				for (n in e = g(e), t)if (t.hasOwnProperty(n) && null !== n)for (var o = 0; o < e.length; o++)e[o].style[n] = t[n];
				return e
			}
			...
			function T(e, t) {
				return e && 1 === e.nodeType ? N(e, t) ? e : T(e.parentNode, t) : null
			}
			...
			function V(e, t) {
				return D(e, t, "nextElementSibling")
			}

			function W(e, t) {
				return D(e, t, "previousElementSibling")
			}
			...
			var X = "fullpage-wrapper", F = "." + X, Z = "fp-responsive", G = "fp-notransition", U = "fp-destroyed",
					$ = "fp-enabled", Q = "fp-viewing", J = "active", K = "." + J, q = "fp-completely", ee = "fp-section",
					te = "." + ee, ne = te + K, oe = "fp-tableCell", re = "." + oe, ie = "#fp-nav", le = "fp-slide",
					ae = "." + le, se = ae + K, ce = "fp-slides", ue = "." + ce, fe = "fp-slidesContainer", de = "." + fe,
					ve = "fp-table", pe = "fp-slidesNav", he = "." + pe, ge = he + " a", me = ".fp-controlArrow",
					Se = me + ".fp-prev", be = me + ".fp-next";
			return e.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (t, n) {
				...
				function x(e, t) {
					...
					if (g.autoScrolling && !g.scrollBar) s(yn, {
						overflow: "hidden",
						height: "100%"
					}), k(oo.recordHistory, "internal"), s(Rn, {
						"-ms-touch-action": "none",
						"touch-action": "none"
					}), null != n && on(n.offsetTop); else if (s(yn, {
								overflow: "visible",
								height: "initial"
							}), k(!!g.autoScrolling && oo.recordHistory, "internal"), s(Rn, {
								"-ms-touch-action": "",
								"touch-action": ""
							}), an(Rn), null != n) {
				...
				function we(n) {
					...
					}(), Rn.addEventListener("mousedown", Tt), Rn.addEventListener("mouseup", Ot)) : (t.addEventListener ? (t.removeEventListener("mousewheel", Ke, !1), t.removeEventListener("wheel", Ke, !1), t.removeEventListener("MozMousePixelScroll", Ke, !1)) : t.detachEvent("onmousewheel", Ke), Rn.removeEventListener("mousedown", Tt), Rn.removeEventListener("mouseup", Ot))
				}

				function Ee(e, t) {
					void 0 !== t ? (t = t.replace(/ /g, "").split(",")).forEach(function (t) {
						ln(e, t, "m")
					}) : ln(e, "all", "m"), j(Rn, "setAllowScrolling", {value: e, directions: t})
				}

				function xe(e) {
					e ? (we(!0), function () {
						if (Cn || kn) {
							g.autoScrolling && (En.removeEventListener(Qn.touchmove, Ge, {passive: !1}), En.addEventListener(Qn.touchmove, Ge, {passive: !1}));
							var e = g.touchWrapper;
							e.removeEventListener(Qn.touchstart, Qe), e.removeEventListener(Qn.touchmove, Ue, {passive: !1}), e.addEventListener(Qn.touchstart, Qe), e.addEventListener(Qn.touchmove, Ue, {passive: !1})
						}
					}()) : (we(!1), function () {
						if (Cn || kn) {
							g.autoScrolling && (En.removeEventListener(Qn.touchmove, Ue, {passive: !1}), En.removeEventListener(Qn.touchmove, Ge, {passive: !1}));
							var e = g.touchWrapper;
							e.removeEventListener(Qn.touchstart, Qe), e.removeEventListener(Qn.touchmove, Ue, {passive: !1})
						}
					}())
				}
				...
				function Te(e, t) {
					D(0, "internal"), Oe(e, t), D(oo.scrollingSpeed, "internal")
				}
				...
				function Re(t) {
					if (!i(Rn, U)) {
						...
						for (var n = o(te), r = 0; r < n.length; ++r) {
							var c = n[r], u = o(ue, c)[0], f = o(ae, c);
							g.verticalCentered && s(o(re, c), {height: Ft(c) + "px"}), s(c, {height: De(c) + "px"}), 1 < f.length && Ht(u, o(se, u)[0])
						}
						g.scrollOverflow && Pn.createScrollBarForAll();
						var d = h(o(ne)[0], te);
						d && !sn("fadingEffect") && Te(d + 1), In = !1, I(g.afterResize) && t && g.afterResize.call(Rn, e.innerWidth, e.innerHeight), I(g.afterReBuild) && !t && g.afterReBuild.call(Rn), j(Rn, "afterRebuild")
					}
				}
				...
				function ze(e) {
					var t = He();
					e ? t || (x(!1, "internal"), ye(!1, "internal"), m(o(ie)), y(En, Z), I(g.afterResponsive) && g.afterResponsive.call(Rn, e), g.responsiveSlides && xn.responsiveSlides && xn.responsiveSlides.toSections(), j(Rn, "afterResponsive", e), g.scrollOverflow && Pn.createScrollBarForAll()) : t && (x(oo.autoScrolling, "internal"), ye(oo.autoScrolling, "internal"), S(o(ie)), w(En, Z), I(g.afterResponsive) && g.afterResponsive.call(Rn, e), g.responsiveSlides && xn.responsiveSlides && xn.responsiveSlides.toSlides(), j(Rn, "afterResponsive", e))
				}

				function Ie(e) {
					var t = e.target;
					t && T(t, ie + " a") ? function (e) {
						z(e);
					...
					}.call(t, e) : N(t, ge) || null != T(t, ge) ? function (e) {
						z(e);
						var t = o(ue, T(this, te))[0];
						Ht(t, o(ae, t)[h(T(this, "li"))])
					}.call(t, e) : T(t, g.menu + " [data-menuanchor]") && function (e) {
								!o(g.menu)[0] || !g.lockAnchors && g.anchors.length || (z(e), Oe(this.getAttribute("data-menuanchor")))
							}.call(t, e)
				}
				...
				function Ne(e) {
					var n = event.toElement || e.relatedTarget || e.target, o = e.type, r = !1;
					n != t && n ? ("touchend" === o && (io = !1, setTimeout(function () {
						io = !0
					}, 800)), ("mouseenter" !== o || io) && (g.normalScrollElements.split(",").forEach(function (e) {
						if (!r) {
							var t = N(n, e), o = T(n, e);
							(t || o) && (xn.shared.isNormalScrollElement || xe(!1), xn.shared.isNormalScrollElement = !0, r = !0)
						}
					}), !r && xn.shared.isNormalScrollElement && (xe(!0), xn.shared.isNormalScrollElement = !1))) : xe(!0)
				}

				function _e() {
					var e = l(), t = a();
					Hn === e && zn === t || (Hn = e, zn = t, Re(!0))
				}

				function Be(t) {
					var n = "fp_" + t + "Extension";
					lo[t] = g[t + "Key"], xn[t] = void 0 !== e[n] ? new e[n] : null, xn[t] && xn[t].c(t)
				}

				function Pe(e, n, r) {
					var i = 100 * r, l = 100 / r, a = t.createElement("div");
					a.className = ce, A(n, a);
					var c, u, f = t.createElement("div");
					f.className = fe, A(n, f), s(o(de, e), {width: i + "%"}), 1 < r && (g.controlArrows && (c = e, u = [B('<div class="fp-controlArrow fp-prev"></div>'), B('<div class="fp-controlArrow fp-next"></div>')], O(o(ue, c)[0], u), "#fff" !== g.controlArrowColor && (s(o(be, c), {"border-color": "transparent transparent transparent " + g.controlArrowColor}), s(o(Se, c), {"border-color": "transparent " + g.controlArrowColor + " transparent transparent"})), g.loopHorizontal || m(o(Se, c))), g.slidesNavigation && function (e, t) {
						...
						s(n, {"margin-left": "-" + n.innerWidth / 2 + "px"}), y(o("a", o("li", n)[0]), J)
				...
				function Ve(e, t) {
					t || null != o(ne)[0] || y(e, J), Tn = o(ne)[0], s(e, {height: De(e) + "px"}), g.paddingTop && s(e, {"padding-top": g.paddingTop}), g.paddingBottom && s(e, {"padding-bottom": g.paddingBottom}), void 0 !== g.sectionsColor[t] && s(e, {"background-color": g.sectionsColor[t]}), void 0 !== g.anchors[t] && e.setAttribute("data-anchor", g.anchors[t])
				}
				...
				function Ye() {
					var e, t, n = o(ne)[0];
					y(n, q), ut(n), ct(), dt(n), g.scrollOverflow && g.scrollOverflowHandler.afterLoad(), e = At(), t = Gt(e.section), e.section && t && (void 0 === t || h(t) !== h(Tn)) || !I(g.afterLoad) || ot("afterLoad", {
						activeSection: n,
						element: n,
						direction: null,
						anchorLink: n.getAttribute("data-anchor"),
						sectionIndex: h(n, te)
					}), I(g.afterRender) && ot("afterRender"), j(Rn, "afterRender")
				}

				function Xe() {
					var e;
					if (j(Rn, "onScroll"), (!g.autoScrolling || g.scrollBar || sn("dragAndMove")) && !fn()) {
						var t = sn("dragAndMove") ? Math.abs(xn.dragAndMove.getCurrentScroll()) : R(), n = 0, r = t + l() / 2,
								a = (sn("dragAndMove") ? xn.dragAndMove.getDocumentHeight() : En.offsetHeight - l()) === t, s = o(te);
						if (a) n = s.length - 1; else if (t)for (var c = 0; c < s.length; ++c)s[c].offsetTop <= r && (n = c); else n = 0;
						if (!i(e = s[n], J)) {
							uo = !0;
							var u, f, d = o(ne)[0], v = h(d, te) + 1, p = Wt(e), m = e.getAttribute("data-anchor"), S = h(e, te) + 1,
									b = o(se, e)[0], E = {
										activeSection: d,
										sectionIndex: S - 1,
										anchorLink: m,
							...
							b && (f = b.getAttribute("data-anchor"), u = h(b)), Nn && (y(e, J), w(H(e), J), cn("parallax", "afterLoad"), I(g.onLeave) && ot("onLeave", E), I(g.afterLoad) && ot("afterLoad", E), g.resetSliders && xn.resetSliders && xn.resetSliders.apply({
								localIsResizing: In,
								leavingSection: v
							}), pt(d), ut(e), dt(e), Vt(m, S - 1), g.anchors.length && (An = m), Qt(u, f, m)), clearTimeout(Xn), Xn = setTimeout(function () {
								uo = !1
							}, 100)
						}
						g.fitToSection && (clearTimeout(Fn), Fn = setTimeout(function () {
							g.fitToSection && o(ne)[0].offsetHeight <= Hn && Fe()
						}, g.fitToSectionDelay))
					}
				}

				function Fe() {
					Nn && (In = !0, nt(o(ne)[0]), In = !1)
				}

				function Ze(e) {
					if (Bn.m[e]) {
						var t = "down" === e ? Me : Le;
						if (xn.scrollHorizontally && (t = xn.scrollHorizontally.getScrollSection(e, t)), g.scrollOverflow) {
							var n = g.scrollOverflowHandler.scrollable(o(ne)[0]), r = "down" === e ? "bottom" : "top";
							if (null != n) {
				...
				function Ge(e) {
					g.autoScrolling && $e(e) && Bn.m.up && z(e)
				}
				...
				function Ue(t) {
					...
					if ($e(t)) {
						g.autoScrolling && z(t);
						var r = tn(t);
						po = r.y, ho = r.x, o(ue, n).length && Math.abs(vo - ho) > Math.abs(fo - po) ? !On && Math.abs(vo - ho) > a() / 100 * g.touchSensitivity && (ho < vo ? Bn.m.right && Ce(n) : Bn.m.left && ke(n)) : g.autoScrolling && Nn && Math.abs(fo - po) > e.innerHeight / 100 * g.touchSensitivity && (po < fo ? Ze("down") : fo < po && Ze("up"))
					}
				}
				...
				function Ke(t) {
					var n = (new Date).getTime(), r = i(o(".fp-completely")[0], "fp-normal-scroll");
					if (!Bn.m.down && !Bn.m.up)return z(t), !1;
					if (g.autoScrolling && !Mn && !r) {
						var l = (t = t || e.event).wheelDelta || -t.deltaY || -t.detail, a = Math.max(-1, Math.min(1, l)),
						...
						149 < _n.length && _n.shift(), _n.push(Math.abs(l)), g.scrollBar && z(t);
						var u = n - go;
						if (go = n, 200 < u && (_n = []), Nn && !un()) {
							var f = Je(_n, 10);
							Je(_n, 70) <= f && c && Ze(a < 0 ? "down" : "up")
						}
						return !1
					}
					g.fitToSection && (to = !1)
				...
				function qe(e, t) {
					var n = null == t ? o(ne)[0] : t, r = o(ue, n)[0];
					if (!(null == r || un() || On || o(ae, r).length < 2)) {
						var i = o(se, r)[0], l = null;
						if (null == (l = "left" === e ? u(i, ae) : f(i, ae))) {
							if (!g.loopHorizontal)return;
							var a = H(i);
							l = "left" === e ? a[a.length - 1] : a[0]
						}
						On = !xn.test.isTesting, Ht(r, l, e)
					}
				}
				...
				function tt(e) {
					var t = e.offsetHeight, n = e.offsetTop, o = n,
							r = sn("dragAndMove") && xn.dragAndMove.isGrabbing ? xn.dragAndMove.isScrollingDown() : mo < n,
							i = o - Hn + t, l = g.bigSectionsDestination;
					return Hn < t ? (r || l) && "bottom" !== l || (o = i) : (r || In && null == v(e)) && (o = i), g.offsetSections && xn.offsetSections && (o = xn.offsetSections.getSectionPosition(r, o, e)), mo = o
				}
				...
				function nt(e, t, n) {
					if (null != e) {
						...
						if (!(a.activeSection == e && !In || g.scrollBar && R() === a.dtop && !i(e, "fp-auto-height"))) {
							if (null != a.activeSlide && (r = a.activeSlide.getAttribute("data-anchor"), l = h(a.activeSlide)), !a.localIsResizing) {
								var s = a.yMovement;
								if (void 0 !== n && (s = n ? "up" : "down"), a.direction = s, I(g.onLeave) && !1 === ot("onLeave", a))return
							}
							var c;
							cn("parallax", "apply", a), cn("cards", "apply", a), g.autoScrolling && g.continuousVertical && void 0 !== a.isMovementUp && (!a.isMovementUp && "up" == a.yMovement || a.isMovementUp && "down" == a.yMovement) && ((u = a).isMovementUp ? C(o(ne)[0], V(u.activeSection, te)) : O(o(ne)[0], W(u.activeSection, te).reverse()), on(o(ne)[0].offsetTop), et(), u.wrapAroundElements = u.activeSection, u.dtop = u.element.offsetTop, u.yMovement = Wt(u.element), u.leavingSection = h(u.activeSection, te) + 1, u.sectionIndex = h(u.element, te), j(o(F)[0], "onContinuousVertical", u), a = u), sn("scrollOverflowReset") && xn.scrollOverflowReset.setPrevious(a.activeSection), a.localIsResizing || pt(a.activeSection), g.scrollOverflow && g.scrollOverflowHandler.beforeLeave(), y(e, J), w(H(e), J), ut(e), g.scrollOverflow && g.scrollOverflowHandler.onLeave(), Nn = xn.test.isTesting, Qt(l, r, a.anchorLink, a.sectionIndex), function (e) {
								if (g.css3 && g.autoScrolling && !g.scrollBar) Zt("translate3d(0px, -" + Math.round(e.dtop) + "px, 0px)", !0), g.scrollingSpeed ? (clearTimeout(Wn), Wn = setTimeout(function () {
									at(e)
								}, g.scrollingSpeed)) : at(e); else {
									var t = lt(e.dtop);
							...
							}(a), An = a.anchorLink, Vt(a.anchorLink, null == (c = a).wrapAroundElements ? c.sectionIndex : c.isMovementUp ? o(te).length - 1 : 0)
						}
					}
					var u
				}
				...
				function ot(e, t) {
					var n, r, i, l, a = (r = e, i = t, (l = g.v2compatible ? {
						...
						afterRender: function () {
							return {section: rt(o(ne)[0]), slide: it(o(se, o(ne)[0])[0])}
						}, onLeave: function () {
							return {origin: rt(i.activeSection), destination: rt(i.element), direction: i.direction}
						}, afterLoad: function () {
							return l.onLeave()
						}, afterSlideLoad: function () {
							return {
				...
				function ft(e) {
					g.scrollOverflow && (clearTimeout(no), no = setTimeout(function () {
				...
				function mt(e) {
					var n = void 0 !== lo[e] && lo[e].length, o = [], r = !1;
					return b(lo[e]) ? o = lo[e] : o.push(lo[e]), o.forEach(function (o) {
						var i = function () {
									if (t.domain.length) {
									...
									return ""
								}(), l = ["MTM0bG9jYWxob3N0MjM0", "MTM0MC4xMjM0", "MTM0anNoZWxsLm5ldDIzNA==", "UDdDQU5ZNlNN"], a = gt(l[0]),
								s = gt(l[1]), c = gt(l[2]), u = gt(l[3]), f = [a, s, c].indexOf(i) < 0 && 0 !== i.length;
						if (!n && f)return !1;
						var d = n ? gt(o) : "", v = 1 < (d = d.split("_")).length && -1 < d[1].indexOf(e, d[1].length - e.length),
				...
				function St(e) {
					e.forEach(function (e) {
						e.removedNodes[0] && e.removedNodes[0].isEqualNode(so) && (clearTimeout(co), co = setTimeout(bt, 900))
					})
				}
				...
				function yt(n) {
					so = t.createElement("div"), ao = gt("MTIzPGRpdj48YSBocmVmPSJodHRwOi8vYWx2YXJvdHJpZ28uY29tL2Z1bGxQYWdlL2V4dGVuc2lvbnMvIiBzdHlsZT0iY29sb3I6ICNmZmYgIWltcG9ydGFudDsgdGV4dC1kZWNvcmF0aW9uOm5vbmUgIWltcG9ydGFudDsiPlVubGljZW5zZWQgZnVsbFBhZ2UuanMgRXh0ZW5zaW9uPC9hPjwvZGl2PjEyMw=="), so.innerHTML = ao, so = so.firstChild, "MutationObserver" in e && new MutationObserver(St).observe(t.body, {
						childList: !0,
						subtree: !1
					}), sn(n) && xn[n] && (mt(n) || (wt(), setInterval(wt, 2e3)))
				}

				function wt() {
					so && (Jn || (Math.random() < .5 ? Y(En, so) : E(so, En), Jn = !0), so.setAttribute("style", gt("").replace(/;/g, gt("MTIzICFpbXBvcnRhbnQ7MzQ1"))))
				}

				function Et() {
					var e = At(), t = e.section, n = e.slide;
					t && (g.animateAnchor ? Ut(t, n) : Te(t, n))
				}

				function xt() {
					if (!uo && !g.lockAnchors) {
						var e = At(), t = e.section, n = e.slide, o = void 0 === An, r = void 0 === An && void 0 === n && !On;
						if (t && t.length) {
							var i = !sn("dragAndMove") || Ln;
							(t && t !== An && !o || r || !On && Ln != n && i) && Ut(t, n)
						}
					}
				}
				...
				function Lt(e) {
					...
					9 === r ? function (e) {
						...
						var r, i, l, a, s, c, u, f = e.shiftKey, d = t.activeElement, v = Ct(ht(o(ne)[0]));
						r = e, i = Ct(t), l = i.indexOf(t.activeElement), a = r.shiftKey ? l - 1 : l + 1, s = i[a], c = it(T(s, ae)), u = rt(T(s, te)), (c || u) && (d ? null == T(d, ne + "," + ne + " " + se) && (d = n(e)) : n(e), (!f && d == v[v.length - 1] || f && d == v[0]) && z(e))
					}(e) : N(n, "textarea") || N(n, "input") || N(n, "select") || "true" === n.getAttribute("contentEditable") || "" === n.getAttribute("contentEditable") || !g.keyboardScrolling || !g.autoScrolling || (-1 < [40, 38, 32, 33, 34].indexOf(r) && z(e), Mn = e.ctrlKey, Zn = setTimeout(function () {
								!function (e) {
									var n = e.shiftKey, r = t.activeElement, i = N(r, "video") || N(r, "audio");
				...
				function Tt(e) {
					2 == e.which && (So = e.pageY, Rn.addEventListener("mousemove", Rt))
				}
				...
				function Ct(e) {
					return [].slice.call(o(Kn, e)).filter(function (e) {
				...
				function Rt(e) {
					g.autoScrolling && (Nn && (e.pageY < So && Bn.m.up ? Le() : e.pageY > So && Bn.m.down && Me()), So = e.pageY)
				}
				...
				function Ht(e, t, n) {
					...
					l.xMovement = Yt(l.prevSlideIndex, l.slideIndex), l.direction = l.direction ? l.direction : l.xMovement, l.localIsResizing || (Nn = !1), cn("parallax", "applyHorizontal", l), cn("cards", "apply", l), g.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && I(g.onSlideLeave) && !1 === ot("onSlideLeave", l) ? On = !1 : (y(t, J), w(H(t), J), l.localIsResizing || (pt(l.prevSlide), ut(t)), zt(l), i(r, J) && !l.localIsResizing && Qt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), xn.continuousHorizontal && xn.continuousHorizontal.apply(l), fn() ? It(l) : jt(e, l, !0), g.interlockedSlides && xn.interlockedSlides && (sn("continuousHorizontal") && void 0 !== n && n !== l.xMovement || xn.interlockedSlides.apply(l)))
				}
				...
				function Nt() {
					clearTimeout(Dn), Dn = setTimeout(function () {
						for (var e = 0; e < 4; e++)Vn = setTimeout(_t, 200 * e)
					}, 200)
				}
				...
				function _t() {
					if (j(Rn, "onResize"), Bt(), Cn) {
						...
						if (!N(e, "textarea") && !N(e, "input") && !N(e, "select")) {
							var n = l();
							Math.abs(n - bo) > 20 * Math.max(bo, n) / 100 && (Re(!0), bo = n)
						}
					} else _e()
				}

				function Bt() {
					var t = g.responsive || g.responsiveWidth, n = g.responsiveHeight, o = t && e.innerWidth < t,
							r = n && e.innerHeight < n;
				...
				function Xt(e) {
					if (!i(e, ve)) {
						var n = t.createElement("div");
						n.className = oe, n.style.height = Ft(e) + "px", y(e, ve), L(e, n)
					}
				}
				...
				function Ft(e) {
					...
					if (g.paddingTop || g.paddingBottom) {
						var n = e;
						i(n, ee) || (n = T(e, te)), t -= parseInt(getComputedStyle(n)["padding-top"]) + parseInt(getComputedStyle(n)["padding-bottom"])
					}
					return t
				}

				function Zt(e, t) {
					t ? Pt(Rn) : Dt(Rn), clearTimeout(Un), s(Rn, rn(e)), xn.test.translate3d = e, Un = setTimeout(function () {
						w(Rn, G)
					}, 10)
				}
				...
				function Ut(e, t) {
					...
					if (null != n) {
						var r, l, a,
								s = (null == (a = o(ae + '[data-anchor="' + (r = t) + '"]', l = n)[0]) && (r = void 0 !== r ? r : 0, a = o(ae, l)[r]), a);
				...
				function Jt(t) {
					if (g.recordHistory) location.hash = t; else if (Cn || kn) e.history.replaceState(void 0, void 0, "#" + t); else {
				...
				function Kt(e) {
					if (!e)return null;
					var t = e.getAttribute("data-anchor"), n = h(e);
					return null == t && (t = n), t
				}

				function qt() {
					var e = o(ne)[0], t = o(se, e)[0], n = Kt(e), r = Kt(t), i = String(n);
				...
				function nn(e, t) {
					D(0, "internal"), void 0 !== t && (In = !0), Ht(T(e, ue), e), void 0 !== t && (In = !1), D(oo.scrollingSpeed, "internal")
				}

				function on(e) {
					var t = Math.round(e);
					if (g.css3 && g.autoScrolling && !g.scrollBar) Zt("translate3d(0px, -" + t + "px, 0px)", !1); else if (g.autoScrolling && !g.scrollBar) s(Rn, {top: -t + "px"}), xn.test.top = -t + "px"; else {
						var n = lt(t);
				...
				var bn = g && new RegExp("([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$").test(g.licenseKey) || -1 < t.domain.indexOf("alvarotrigo.com"),
						yn = o("html, body"), wn = o("html")[0], En = o("body")[0];
				if (!i(wn, $)) {
					var xn = {};
					g = r({
						menu: !1,
					...
					var An, Ln, Mn, Tn, On = !1,
							...
							Rn = "string" == typeof c ? o(c)[0] : c, Hn = l(), zn = a(), In = !1, jn = !0, Nn = !0, _n = [],
							Bn = {m: {up: !0, down: !0, left: !0, right: !0}};
					Bn.k = r({}, Bn.m);
					var Pn, Dn, Vn, Wn, Yn, Xn, Fn, Zn, Gn, Un, $n = en(), Qn = {
								touchmove: "ontouchmove" in e ? "touchmove" : $n.move,
								touchstart: "ontouchstart" in e ? "touchstart" : $n.down
							}, Jn = !1,
							Kn = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]',
							qn = !1;
					try {
						...
						e.addEventListener("testPassive", null, eo), e.removeEventListener("testPassive", null, eo)
					} catch (c) {
					}
					var to, no, oo = r({}, g), ro = !1, io = !0, lo = {};
					vn(), e.fp_easings = r(e.fp_easings, {
						easeInOutCubic: function (e, t, n, o) {
							return (e /= o / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e + 2) + t
						}
					}), Rn && (xn.version = "3.0.5", xn.setAutoScrolling = x, xn.setRecordHistory = k, xn.setScrollingSpeed = D, xn.setFitToSection = ye, xn.setLockAnchors = function (e) {
						g.lockAnchors = e
					}, xn.setMouseWheelScrolling = we, xn.setAllowScrolling = Ee, xn.setKeyboardScrolling = Ae, xn.moveSectionUp = Le, xn.moveSectionDown = Me, xn.silentMoveTo = Te, xn.moveTo = Oe, xn.moveSlideRight = Ce, xn.moveSlideLeft = ke, xn.fitToSection = Fe, xn.reBuild = Re, xn.setResponsive = ze, xn.getFullpageData = function () {
						return {
							options: g,
							internals: {
								container: Rn,
								...
								isReallyTouch: $e,
								usingExtension: sn,
								toggleControlArrows: zt,
								touchStartHandler: Qe,
								touchMoveHandler: Ue
							}
						}
					}, xn.destroy = function (n) {
						j(Rn, "destroy", n), x(!1, "internal"), Ee(!0), xe(!1), Ae(!1), y(Rn, U), [Yn, Wn, Dn, Xn, Fn, Gn, Vn].forEach(function (e) {
							clearTimeout(e)
						}), e.removeEventListener("scroll", Xe), e.removeEventListener("hashchange", xt), e.removeEventListener("resize", Nt), t.removeEventListener("keydown", Lt), t.removeEventListener("keyup", Mt), ["click", "touchstart"].forEach(function (e) {
							t.removeEventListener(e, Ie)
						}), ["mouseenter", "touchstart", "mouseleave", "touchend"].forEach(function (e) {
							t.removeEventListener(e, Ne, !0)
						}), sn("dragAndMove") && xn.dragAndMove.destroy(), n && (on(0), o("img[data-src], source[data-src], audio[data-src], iframe[data-src]", Rn).forEach(function (e) {
							st(e, "src")
							...
							"-ms-touch-action": "",
							"touch-action": ""
						}), s(yn, {overflow: "", height: ""}), w(wn, $), w(En, Z), En.className.split(/\s+/).forEach(function (e) {
							0 === e.indexOf(Q) && w(En, e)
						}), o(te + ", " + ae).forEach(function (e) {
							g.scrollOverflowHandler && g.scrollOverflow && g.scrollOverflowHandler.remove(e), w(e, ve + " " + J + " " + q), e.getAttribute("data-fp-styles") && e.setAttribute("style", e.getAttribute("data-fp-styles")), i(e, ee) && !ro && e.removeAttribute("data-anchor")
					...
					}, e.fullpage_api = xn, g.$ && Object.keys(xn).forEach(function (e) {
						g.$.fn.fullpage[e] = xn[e]
					}), Be("continuousHorizontal"), Be("scrollHorizontally"), Be("resetSliders"), Be("interlockedSlides"), Be("responsiveSlides"), Be("fadingEffect"), Be("dragAndMove"), Be("offsetSections"), Be("scrollOverflowReset"), Be("parallax"), Be("cards"), sn("dragAndMove") && xn.dragAndMove.init(), g.css3 && (g.css3 = function () {
						...
						if (!g.anchors.length) {
							var e = "[data-anchor]", t = o(g.sectionSelector.split(",").join(e + ",") + e, Rn);
							t.length && (ro = !0, t.forEach(function (e) {
								g.anchors.push(e.getAttribute("data-anchor").toString())
							}))
						}
						if (!g.navigationTooltips.length) {
							var e = "[data-tooltip]", n = o(g.sectionSelector.split(",").join(e + ",") + e, Rn);
						...
						s(Rn, {
							height: "100%",
							position: "relative"
						}), y(Rn, X), y(wn, $), Hn = l(), w(Rn, U), y(o(g.sectionSelector, Rn), ee), y(o(g.slideSelector, Rn), le), cn("parallax", "init");
						for (var e = o(te), n = 0; n < e.length; n++) {
							var r = n, a = e[n], c = o(ae, a), u = c.length;
							a.setAttribute("data-fp-styles", a.getAttribute("style")), Ve(a, r), f = a, d = r, void 0 !== g.anchors[d] && i(f, J) && Vt(g.anchors[d], d), g.menu && g.css3 && null != T(o(g.menu)[0], F) && o(g.menu).forEach(function (e) {
								En.appendChild(e)
						...
						g.fixedElements && g.css3 && o(g.fixedElements).forEach(function (e) {
							...
							o("ul", r)[0].innerHTML = i, s(o(ie), {"margin-top": "-" + o(ie)[0].offsetHeight / 2 + "px"}), y(o("a", o("li", o(ie)[0])[h(o(ne)[0], te)]), J)
						}(), o('iframe[src*="youtube.com/embed/"]', Rn).forEach(function (e) {
							var t, n, o;
							n = "enablejsapi=1", o = (t = e).getAttribute("src"), t.setAttribute("src", o + (/\?/.test(o) ? "&" : "?") + n)
						}), g.fadingEffect && xn.fadingEffect && xn.fadingEffect.apply(), sn("cards") && xn.cards.init(), g.scrollOverflow && (Pn = g.scrollOverflowHandler.init(g))
					...
					}(), e.addEventListener("scroll", Xe), e.addEventListener("hashchange", xt), e.addEventListener("blur", kt), e.addEventListener("resize", Nt), t.addEventListener("keydown", Lt), t.addEventListener("keyup", Mt), ["click", "touchstart"].forEach(function (e) {
						t.addEventListener(e, Ie)
					}), g.normalScrollElements && (["mouseenter", "touchstart"].forEach(function (e) {
						je(e, !1)
					}), ["mouseleave", "touchend"].forEach(function (e) {
						je(e, !0)
					})), sn("dragAndMove") && xn.dragAndMove.turnOffTouch());
					var ao, so, co, uo = !1, fo = 0, vo = 0, po = 0, ho = 0, go = (new Date).getTime(), mo = 0, So = 0, bo = Hn;
					return xn
				}
				vn()
			}
		...
		t.default = {
			methods: {
				build: function () {
					var e = this.options.slideSelector || ".slide", t = this.options.sectionSelector || ".section",
							n = fp_utils.index(document.querySelector(t + ".active")),
							o = document.querySelector(t + ".active " + e + ".active"), r = o ? fp_utils.index(o) : -1;
			...
			}, props: {options: {type: Object, required: !0}}, watch: {
				options: {
		...
		Object.defineProperty(t, "__esModule", {value: !0}), t.version = t.FullPage = void 0;
		var i = n(1), l = o(i), a = n(0), s = o(a);
		...
		e.exports = function (e, t, n, o, r) {
			var i, l = e = e || {}, a = typeof e.default;
			...
			if (r ? (c = function (e) {
				...
				var u = s.functional, f = u ? s.render : s.beforeCreate;
		...
		e.exports = {
			render: function () {
				...
				return (e._self._c || t)("div", {ref: "fullpage"}, [e._t("default")], 2)
			}, staticRenderFns: []
		}
	}])
});